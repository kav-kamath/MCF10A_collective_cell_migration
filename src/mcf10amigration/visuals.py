...
def plot_static_light_pattern(light_pattern, save_boolean=False, output_filename="static_light_pattern.png"):
    """
    ...
    plt.imshow(light_pattern, cmap='hot', interpolation='nearest')
